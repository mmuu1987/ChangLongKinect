...
namespace com.rfilkov.kinect
{
    ...
    public class Kinect4AzureInterface : DepthSensorBase
    {
        ...
        public k4abt_tracker_processing_mode_t bodyTrackingProcessingMode = k4abt_tracker_processing_mode_t.K4ABT_TRACKER_PROCESSING_MODE_GPU_DIRECTML;
        ...
        private bool InitBodyTracking(KinectInterop.FrameSource dwFlags, KinectInterop.SensorData sensorData, Calibration calibration, bool bCreateTracker)
        {
            try
            {
                if ((dwFlags & KinectInterop.FrameSource.TypeDepth) != 0)  // check for depth stream
                {
                    ...
                    KinectInterop.CopyFolderFile(bodyTrackingPath, BODY_TRACKING_MODEL_FILE, ".");
                    ...
                    if (bCreateTracker)
                    {
                        ...
                        btConfig.model_path = BODY_TRACKING_MODEL_FILE;
